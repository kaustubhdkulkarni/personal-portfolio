          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                kaustubhkulkarni035@gmail.com
              </span>
              <a
                href="mailto:kaustubhkulkarni035@gmail.com.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">869154509</span>
              <a
                href="https://api.whatsapp.com/send?phone=8669154509&text=Hello, more information!"
                className="contact__button"
              >
                Contact Me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
