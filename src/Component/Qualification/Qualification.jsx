          ...
          >
            <div className="qualification__data">
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> Aug/2019-July/2023
                </div>
              </div>
              <div>
            ...
            <div className="qualification__data">
              ...
              <div>
                ...
                <span className="qualification__subtitle">
                  S.B Colleage of Science <br />
                  Aurangabad
                </span>
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> Mar/2017-Mar/2019
                </div>
              </div>
            </div>
            ...
            <div className="qualification__data">
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> Mar-2017
                </div>
              </div>
              <div>
                <span className="qualification__rounder"></span>
